...
test("getCotacaoAPI", () => {
  ...
  api.getCotacaoAPI("url").then(resp => {
    ...
    expect(axios.get.mock.calls[0][0]).toEqual("url"); // verifica se o axios é chamado pela ulr passada
  });
});
...
test("getCotacao", () => {
  ...
  getCotacaoAPI.mockRejectedValue(res);
